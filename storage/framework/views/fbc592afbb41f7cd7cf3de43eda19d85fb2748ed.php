...
<div class="form-group">
    <label for="number_display"><?php echo e(__('Number categories to display')); ?></label>
    <input type="number" class="form-control" name="number_display" value="<?php echo e($config['number_display']); ?>">
</div>
<?php /**PATH D:\Projects\xampp8\htdocs\iveEkart\platform/themes/martfury/////widgets/blog-categories/templates/backend.blade.php ENDPATH**/ ?>