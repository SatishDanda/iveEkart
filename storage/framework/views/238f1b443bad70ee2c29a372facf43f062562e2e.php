                            ...
                            <div class="pd-all-20">
                                <div class="flexbox-grid-default">
                                    <div class="flexbox-auto-right mr5">
                                        <label
                                            class="title-product-main text-no-bold"><?php echo e(trans('plugins/ecommerce::order.order_information')); ?> <?php echo e($order->code); ?></label>
                                    </div>
                                </div>
                                <div class="mt20">
                                            ...
                                            <tr>
                                                <td class="width-60-px min-width-60-px vertical-align-t">
                                                    <div class="wrap-img"><img
                                                            ...
                                                            alt="<?php echo e($orderProduct->product_name); ?>"></div>
                                                </td>
                                                <td class="pl5 p-r5 min-width-200-px">
                                                    <a class="text-underline hover-underline pre-line" target="_blank"
                                                       href="<?php echo e($product ? route('products.edit', $product->original_product->id) : '#'); ?>"
                                                       title="<?php echo e($product ? $product->original_product->name : $orderProduct->product_name); ?>">
                                                        <?php echo e($product ? $product->original_product->name : $orderProduct->product_name); ?>
                                                    ...
                                                    <?php if(!empty($orderProduct->options) && is_array($orderProduct->options)): ?>
                                                        <?php $__currentLoopData = $orderProduct->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(!empty($option['key']) && !empty($option['value'])): ?>
                                                                <p class="mb-0"><small><?php echo e($option['key']); ?>:
                                                    ...
                                                    <?php if($order->shipment->id): ?>
                                                        <ul class="unstyled">
                                                            <li class="simple-note">
                                                                <a><span><?php echo e($orderProduct->qty); ?></span><span
                                                                        class="text-lowercase"> <?php echo e(trans('plugins/ecommerce::order.completed')); ?></span></a>
                                                                <ul class="dom-switch-target line-item-properties small">
                                                                    <li class="ws-nm">
                                                                        <span class="bull">↳</span>
                                                                        <span
                                                                            class="black"><?php echo e(trans('plugins/ecommerce::order.shipping')); ?> </span>
                                                                        <a class="text-underline bold-light"
                                                                           target="_blank"
                                                                           title="<?php echo e($order->shipping_method_name); ?>"
                                                                           href="<?php echo e(route('ecommerce.shipments.edit', $order->shipment->id)); ?>"><?php echo e($order->shipping_method_name); ?></a>
                                                                    </li>
                                                                    ...
                                                                    <?php if(is_plugin_active('marketplace') && $order->store->name): ?>
                                                                        <li class="ws-nm">
                                                                            <span class="bull">↳</span>
                                                                            <span
                                                                                class="black"><?php echo e(trans('plugins/marketplace::store.store')); ?></span>
                                                                            <a href="<?php echo e($order->store->url); ?>"
                                                                               class="bold-light"
                                                                               target="_blank"><?php echo e($order->store->name); ?></a>
                                                                        </li>
                                                                    <?php endif; ?>
                                                                </ul>
                                                            </li>
                                ...
                                <div class="flexbox-grid-default block-rps-768">
                                    ...
                                    <div class="flexbox-auto-right pl5">
                                                    ...
                                                    <td class="text-end mt10">
                                                        ...
                                                        <?php if($order->payment->id): ?>
                                                            <p class="mb0  font-size-12px"><a
                                                                    ...
                                                                    target="_blank"><?php echo e($order->payment->payment_channel->label()); ?></a>
                                                            </p>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td class="text-end text-no-bold p-none-t pl10">
                                                        <?php if($order->payment->id): ?>
                                                            <a href="<?php echo e(route('payment.show', $order->payment->id)); ?>"
                                                               target="_blank">
                                        ...
                                        <?php if($order->isInvoiceAvailable()): ?>
                                            <div class="text-end">
                                                <a href="<?php echo e(route('orders.generate-invoice', $order->id)); ?>?type=print"
                                                   class="btn btn-primary me-2" target="_blank">
                                                    <i class="fa fa-print"></i> <?php echo e(trans('plugins/ecommerce::order.print_invoice')); ?>

                                                </a>
                                                <a href="<?php echo e(route('orders.generate-invoice', $order->id)); ?>"
                                                   class="btn btn-info">
                                        ...
                                        <div class="py-3">
                                            <form action="<?php echo e(route('orders.edit', $order->id)); ?>">
                                                <label
                                                    class="text-title-field"><?php echo e(trans('plugins/ecommerce::order.note')); ?></label>
                                                <textarea class="ui-text-area textarea-auto-height" name="description"
                                                          rows="3"
                                                          placeholder="<?php echo e(trans('plugins/ecommerce::order.add_note')); ?>"><?php echo e($order->description); ?></textarea>
                                                <div class="mt10">
                                                    <button type="button"
                                                            class="btn btn-primary btn-update-order"><?php echo e(trans('plugins/ecommerce::order.save')); ?></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="pd-all-20 border-top-title-main">
                                    <div class="flexbox-grid-default flexbox-align-items-center">
                                        <div class="flexbox-auto-left">
                                            <svg
                                                class="svg-next-icon svg-next-icon-size-20 <?php if($order->is_confirmed): ?> svg-next-icon-green <?php else: ?> svg-next-icon-gray <?php endif; ?>">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <?php if(!$order->is_confirmed): ?>
                                            <div class="flexbox-auto-left">
                                                <form action="<?php echo e(route('orders.confirm')); ?>">
                                                    ...
                                                    <button
                                                        class="btn btn-primary btn-confirm-order"><?php echo e(trans('plugins/ecommerce::order.confirm')); ?></button>
                                                </form>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="flexbox-grid-default flexbox-flex-wrap flexbox-align-items-center">
                                    ...
                                    <?php elseif($order->payment->id): ?>
                                        ...
                                        <?php if(!$order->payment->status || in_array($order->payment->status, [\Botble\Payment\Enums\PaymentStatusEnum::PENDING])): ?>
                                            <div class="flexbox-auto-left">
                                                <button class="btn btn-primary btn-trigger-confirm-payment"
                                                        data-target="<?php echo e(route('orders.confirm-payment', $order->id)); ?>"><?php echo e(trans('plugins/ecommerce::order.confirm_payment')); ?></button>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED && (($order->payment->amount - $order->payment->refunded_amount > 0) || ($order->products->sum('qty') - $order->products->sum('restock_quantity') > 0))): ?>
                                            <div class="flexbox-auto-left">
                                                <button
                                                    class="btn btn-secondary ml10 btn-trigger-refund"><?php echo e(trans('plugins/ecommerce::order.refund')); ?></button>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                                                ...
                                                <div class="flexbox-auto-left">
                                                    <div class="item">
                                                        <button class="btn btn-primary btn-trigger-shipment"
                                                                data-target="<?php echo e(route('orders.get-shipment-form', $order->id)); ?>"><?php echo e(trans('plugins/ecommerce::order.delivery')); ?></button>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                            ...
                            <div>
                                <div class="comment-log ws-nm">
                                    <div class="comment-log-title">
                                        <label
                                            class="bold-light m-xs-b hide-print"><?php echo e(trans('plugins/ecommerce::order.history')); ?></label>
                                    </div>
                                                                        ...
                                                                        <div class="timeline__inner-message">
                                                                            <?php if(in_array($history->action, ['confirm_payment', 'refund'])): ?>
                                                                                <a href="#"
                                                                                   ...
                                                                                   data-target="#history-line-<?php echo e($history->id); ?>">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="<?php echo e(route('orders.edit', $order->id)); ?>"
                                                                                   title="<?php echo e($order->code); ?>"><?php echo e($order->code); ?></a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <div class="ui-feed__item ui-feed__item--action">
                                                                    ...
                                                                    <div class="timeline__action-group">
                                                                        <a href="#"
                                                                           ...
                                                                           data-action="<?php echo e(route('orders.send-order-confirmation-email', $history->order_id)); ?>"><?php echo e(trans('plugins/ecommerce::order.resend')); ?></a>
                                                                    </div>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                    ...
                    <div class="ui-layout__item">
                        <div class="wrapper-content mb20">
                            <div class="next-card-section p-none-b">
                                <div class="flexbox-grid-default flexbox-align-items-center">
                                    <div class="flexbox-auto-content-left">
                                        <label
                                            class="title-product-main text-no-bold"><?php echo e(trans('plugins/ecommerce::order.customer_label')); ?></label>
                                    </div>
                                    <div class="flexbox-auto-left">
                            ...
                            <div class="next-card-section border-none-t">
                                <div class="mb5">
                                    <strong
                                        class="text-capitalize"><?php echo e($order->user->name ?: $order->address->name); ?></strong>
                                </div>
                                ...
                                <ul class="ws-nm text-infor-subdued">
                                    <li class="overflow-ellipsis"><a class="hover-underline"
                                                                     href="mailto:<?php echo e($order->user->email ?: $order->address->email); ?>"><?php echo e($order->user->email ?: $order->address->email); ?></a>
                                    </li>
                                    <?php if($order->user->id): ?>
                                        <li>
                            ...
                            <div class="next-card-section">
                                <?php if(EcommerceHelper::countDigitalProducts($order->products) != $order->products->count()): ?>
                                    <div class="flexbox-grid-default flexbox-align-items-center">
                                        <div class="flexbox-auto-content-left">
                                            <label
                                                class="title-text-second"><strong><?php echo e(trans('plugins/ecommerce::order.shipping_address')); ?></strong></label>
                                        </div>
                                        <?php if($order->status != \Botble\Ecommerce\Enums\OrderStatusEnum::CANCELED): ?>
                                            <div class="flexbox-auto-content-right text-end">
                                                ...
                                                <span data-placement="top" data-bs-toggle="tooltip"
                                                      data-bs-original-title="<?php echo e(trans('plugins/ecommerce::order.update_address')); ?>">
                                ...
                                <?php if(EcommerceHelper::isBillingAddressEnabled() && $order->billingAddress->id && $order->billingAddress->id != $order->shippingAddress->id): ?>
                                    <div class="flexbox-grid-default flexbox-align-items-center">
                                        <div class="flexbox-auto-content-left">
                                            <label
                                                class="title-text-second"><strong><?php echo e(trans('plugins/ecommerce::order.billing_address')); ?></strong></label>
                                        </div>
                                    </div>
                                    <div>
                                        <ul class="ws-nm text-infor-subdued shipping-address-info">
                                ...
                                <div class="pd-all-20">
                                    <div class="p-b10">
                                        ...
                                        <ul class="p-sm-r mb-0">
                                            <li class="ws-nm">
                                                <a href="<?php echo e($order->store->url); ?>" class="ww-bw text-no-bold"
                                                   target="_blank"><?php echo e($order->store->name); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="wrapper-content bg-gray-white mb20">
                            <div class="pd-all-20">
                                <a href="<?php echo e(route('orders.reorder', ['order_id' => $order->id])); ?>"
                                   class="btn btn-info"><?php echo e(trans('plugins/ecommerce::order.reorder')); ?></a>&nbsp;
                                <?php if($order->canBeCanceledByAdmin()): ?>
                                    <a href="#" class="btn btn-secondary btn-trigger-cancel-order"
                                       data-target="<?php echo e(route('orders.cancel', $order->id)); ?>"><?php echo e(trans('plugins/ecommerce::order.cancel')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\xampp8\htdocs\iveEkart\platform/plugins/ecommerce/resources/views/orders/edit.blade.php ENDPATH**/ ?>