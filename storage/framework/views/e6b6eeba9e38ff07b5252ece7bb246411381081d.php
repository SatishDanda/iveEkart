                            ...
                            <tr>
                                <td class="text-start width-300-px">
                                    <a class="text-underline wordwrap"
                                       href="<?php echo e($product->original_product->id ? route('products.edit', $product->original_product->id) : '#'); ?>" target="_blank" title="<?php echo e($orderProduct->product_name); ?>"><?php echo e($orderProduct->product_name); ?></a>
                                </td>
...
<?php /**PATH D:\Projects\xampp8\htdocs\iveEkart\platform/plugins/ecommerce/resources/views/orders/refund/modal.blade.php ENDPATH**/ ?>