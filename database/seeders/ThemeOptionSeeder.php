    ...
    public function run()
    {
        ...
        SettingModel::insertOrIgnore([
            ...
            [
                ...
                'value' => 'iWekart - Ecommerce system',
            ],
            [
                'key'   => 'theme-' . $theme . '-copyright',
                'value' => '© ' . now()->format('Y') . ' iWekart. All Rights Reserved.',
            ],
            [
            ...
            [
                ...
                'value' => 'Welcome to iWekart Online Shopping Store!',
            ],
            [
        ...
        SettingModel::insertOrIgnore([
            [
                ...
                'value' => '© ' . now()->format('Y') . ' iWekart. Tất cả quyền đã được bảo hộ.',
            ],
            [
                'key'   => 'theme-' . $theme . '-vi-welcome_message',
                'value' => 'Chào mừng đến với iWekart - Cửa Hàng Mua Sắm Online!',
            ],
            [
