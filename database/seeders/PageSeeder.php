        ...
        $pages = [
            [
                ...
                'content'  =>
                    ...
                    Html::tag('div',
                        '[download-app title="Download iWekart App Now!" subtitle="Shopping fastly and easily more with our app. Get a link to download the app on your phone." screenshot="general/app.png" android_app_url="https://www.appstore.com" ios_app_url="https://play.google.com/store"][/download-app]') .
        ...
        $translations = [
            [
                ...
                'content' =>
                    ...
                    Html::tag('div', '[product-category-products category_id="18"][/product-category-products]') .
                    Html::tag('div',
                        '[download-app title="Tải iWekart App Ngay!" subtitle="Mua sắm nhanh chóng và dễ dàng hơn với ứng dụng của chúng tôi. Nhận liên kết để tải xuống ứng dụng trên điện thoại của bạn." screenshot="general/app.png" android_app_url="https://www.appstore.com" ios_app_url="https://play.google.com/store"][/download-app]') .
                    Html::tag('div', '[product-category-products category_id="23"][/product-category-products]') .
                    Html::tag('div',
